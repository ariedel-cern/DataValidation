...
# configure task
export TASK_BASENAME="DefaultCuts"
export ANALYSIS_NAME="DataValidation_DefaultCuts"
...
[kRECO]fEventControlHistograms[kPHI][kAFTER]
[kRECO]fEventControlHistograms[kPT][kAFTER]
[kRECO]fEventControlHistograms[kETA][kAFTER]
EOF
)
...
[ $RUN_OVER_DATA -eq 0 -a $RUN_OVER_AOD -eq 1 ] && export DataDir="$HOME/sim/LHC11a10a_bis/137161/AOD162"
